...
/*
* Трябва да си направя абстактен клас за Cache, който да имплементира всички методи без нещата,
* зависещи от eviction policy. Ще имам класове, които го наследяват и си имплементира нещата,
* които зависят от eviction policy
* */
